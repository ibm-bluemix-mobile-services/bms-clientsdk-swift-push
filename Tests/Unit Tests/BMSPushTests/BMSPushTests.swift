...
class testBMSPushClient: XCTestCase {
    ...
    func testRegister () {
        ...
        clientInstance.initializeBluemixPushWithTenantId("f085b69f-f713-410a-b65d-e7b061")
    ...
    func registerWithUserId(){
        
        BMSClient.sharedInstance.initializeWithBluemixAppRoute("http://sdktest.mybluemix.net", bluemixAppGUID: "f085b69f-f713-410a-b65d-e7b061", bluemixRegion: BMSClient.REGION_US_SOUTH)
        
        let clientInstance = BMSPushClient.sharedInstance
        clientInstance.initializeBluemixPushWithTenantId("f085b69f-f713-410a-b65d-e7b061", bluemixPushClientSecret: "134234-23432423-32423432")
